  ...
  <div className="w-full flex flex-col items-center mt-10 mb-10">
    ...
    {/* 2. AI 맞춤 분석 서비스 강조 섹션 */}
      <div className="w-full min-h-[580px] p-28 bg-gradient-to-r from-white to-[#67F3EC] mt-16 mb-16">
        ...
        <div className="flex flex-col items-start mb-12 text-left space-y-6 text-lg text-gray-800">
        ...
        <Link to="/dog-spa-ai" className="inline-block">
          <button
            className="bg-gradient-to-r from-[#90F9BF] to-[#67F3EC] rounded-lg font-bold text-white hover:shadow-md px-5 py-3 text-2xl shadow-sm"
          >
            추천받으러 가기
          </button>
        </Link>
