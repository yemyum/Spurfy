    ...
    return (
        <section>
            ...
            <div className="flex flex-col items-center justify-center mb-6 relative mt-20">
                ...
                <button className="px-4 py-1 mt-4 text-gray-500 font-semibold rounded-md shadow-sm border border-gray-200 bg-white">
            ...
            <div className="space-y-6 mt-20">
                <h3 className="text-xl font-semibold mb-5">내 정보</h3>
                {/* 1. 이름 정보 */}
                <div className="mb-4">
                ...
                <div className="mb-4">
                    ...
                    {isEditing ? ( // 수정 모드일 때
                        <div className="flex justify-between">
                            <input
                                type="text"
                                className="appearance-none w-full leading-tight focus:outline-none"
                        ...
                        <p className="text-lg mt-2">{profile.nickname}</p>
                    )}
                    <div className="border-t-2 border-gray-200 mt-2 w-full"></div>
                    {/* 닉네임 중복 확인 메시지 표시 */}
                    {isEditing && nicknameCheckMessage && (
                        <p className={`mt-2 ${isNicknameAvailable ? 'text-blue-400' : 'text-red-400'}`}>
                            {nicknameCheckMessage}
                        </p>
                    )}
                </div>
